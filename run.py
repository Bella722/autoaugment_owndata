...
from tensorflow.compat.v1.keras import models, layers, datasets, utils, backend, optimizers, initializers
from transformations import get_transformations
import PIL.Image
import numpy as np
import time
from  data_deal import own_data_loader
...
(Xtr, ytr), (Xts, yts) = own_data_loader()
